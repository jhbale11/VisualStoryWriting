...
export default function TextoshopInterface(props: { children?: React.ReactNode, centerMain?: boolean }) {
    ...
    <>
      <div style={{ display: 'flex', flexDirection: 'row', height: '100vh', background: '#F2EEF0' }}>
        ...
        >
          ...
          {textFields.length > 0 && (
            props.centerMain === false
              ? <EditableTextField isMoveable={false} textField={textFields[0]} />
        ...
        <div id="rightPanel" style={{ position: 'fixed', right: 0, top: 0, paddingTop: 20, paddingRight: 20, paddingBottom: 20, display: 'flex', flexDirection: 'column', gap: 20, height: '100vh', zIndex: 1000 }}>
