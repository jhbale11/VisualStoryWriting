...
export const TranslationMain: React.FC = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<'glossary' | 'translation'>('translation');
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
        ...
        <Tabs
          ...
          onSelectionChange={(key) => {
            setSelectedTab(key as 'glossary' | 'translation');
            if (key === 'glossary') {
                ...
                <Card className="bg-white dark:bg-gray-800">
                  <CardBody className="text-center py-12">
                    ...
                    <p className="text-sm text-gray-400 mb-6">
                      Translation projects use a multi-stage pipeline: Translation → Enhancement → Quality Check → Proofreading → Layout
                    </p>
                    <Button
                      color="success"
                      onPress={() => setIsCreateModalOpen(true)}
                    >
                      Create First Translation Project
                    </Button>
                  </CardBody>
                </Card>
              ) : (
